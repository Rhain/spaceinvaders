...
SpaceInvadersContract.prototype = {
    ...
    setUsername: function (name) {
        ...
        if (name === "") {
            result.code = 1;
            result.msg = "Empty newname!";
            return result;
        }
        if (name.length > 64) {
            result.code = 1;
            result.msg = "newName exceed limit length!";
            return result;
        }
    ...
    changeUsername: function (newName) {
        ...
        if (address) {
            ...
            var lastName = this.addressToName(from);
    ...
    score: function (score, level, date) {
        ...
        if (alreadyInRank) {
            this.ranks = this.ranks.sort(this.compare);
        } else {
            if (this.ranks.length < 100) {
