...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("按空格开始", game.width / 2, game.height/2);
};
...
GameOverState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.font="16px Arial";
    ctx.fillText("你的得分： " + game.score + " ，等级： " + game.level, game.width / 2, game.height/2);
    ctx.font="16px Arial";
    ctx.fillText("按空格重新开始.", game.width / 2, game.height/2 + 40);
};
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.font="14px Arial";
    ctx.fillStyle = '#ffffff';
    var info = "生命: " + game.lives;
    ctx.textAlign = "left";
    ctx.fillText(info, game.gameBounds.left, textYpos);
    info = "得分: " + game.score + ", 等级: " + game.level;
    ctx.textAlign = "right";
...
LevelIntroState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.textBaseline="middle"; 
    ctx.textAlign="center"; 
    ctx.fillText("等级 " + this.level, game.width / 2, game.height/2);
    ctx.font="24px Arial";
    ctx.fillText(this.countdownMessage + " 后开始", game.width / 2, game.height/2 + 36);
    return;
};
